// This class could definitively be refactored, but in the context of my testing mindset it really wasn't my priority.
...
public class ArtefactBehaviour : MonoBehaviour {
    ...
    // REWORK THIS TO SOLVE THE CONFLICT BETWEEN MAGNET / SNAP / RECALL
    private void Update()
    {
        //// ADD A DISTANCE CHECK BETWEEN ARTEFACT AND PLAYER -> END THE HANGING BUT KEEP THE ARTFEFACT MAGNETIZED
