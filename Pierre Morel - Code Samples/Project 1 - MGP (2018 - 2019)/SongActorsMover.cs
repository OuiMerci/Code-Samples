...
public class SongActorsMover : MonoBehaviour
{
    ...
    private void TeleportSongActorsToSongZone(Transform actor1, Transform actor2)
    {
        ...
        _actor1AfterTPPosition = SongManager.Instance.SongZoneCenter.position + (Vector3)centerToActor1Vector;
        _actor2AfterTPPosition = SongManager.Instance.SongZoneCenter.position + (Vector3)centerToActor2Vector;
    ...
    {
        Vector2 center = SongManager.Instance.SongZoneCenter.position;
    ...
    private void OnMovementCompleteReady()
    {
        ...
        _action = Action.Idle;
        SongManager.Instance.OnActorsMoversReady();
    }
